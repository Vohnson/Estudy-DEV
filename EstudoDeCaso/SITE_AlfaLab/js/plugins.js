        ...
        var pluginNS = "mCustomScrollbar",
            ...
            _autoUpdate = function(rem) {
                ...
                var wrapper = mCSB_container.parent(),
                    ...
                    oldSelSize = sizesSum(),
                    newSelSize, os = [mCSB_container.outerHeight(false), mCSB_container.outerWidth(false), wrapper.height(), wrapper.width(), scrollbarSize()[0], scrollbarSize()[1]],
...
function countUp(a, b, c, d, e, f) {
    ...
    m = {
        ...
        run: function() {
            ...
            this.$stage.children("." + this.settings.activeeClass).removeClass(this.settings.activeeClass), this.$stage.children(":eq(" + i.join("), :eq(") + ")").addClass(this.settings.activeeClass), this.settings.center && (this.$stage.children("." + this.settings.centerClass).removeClass(this.settings.centerClass), this.$stage.children().eq(this.current()).addClass(this.settings.centerClass))
        }
...
function(a) {
    ...
    b.Defaults = {
        ...
        if (!e.nav || e.loop || e.navRewind || (this._controls.$previous.toggleClass("disabled", 0 >= f), this._controls.$next.toggleClass("disabled", f >= this._core.maximum())), this._controls.$previous.toggle(e.nav), this._controls.$next.toggle(e.nav), e.dots) {
            ...
            this._controls.$indicators.find(".activee").removeClass("activee"), this._controls.$indicators.children().eq(a.inArray(this.current(), this._pages)).addClass("activee")
        }
